                ...
                div className = "canvas-container-inner" > {
                    ...
                    paths.map(path => {
                        ...
                        span className = "title-name" > Turn < /span> {
                            statusArr[2] ? < div className = "disp-goat"
                            role = 'img'
                            aria - label = 'GOAT' > < /div>: < div className = "disp-tiger"
                            role = 'img'
                            aria - label = 'TIGER' > < /div>}        <
                                button className = {
                                    isAIturn ? "give-up-btn no-click1" : 'give-up-btn'
                                }
                            onClick = {
                                    () => {
                                        setIsOver(true)
...

                            {
                                ...
                                isDraw
                                    ...
                                    <
                                    div className = 'winner winner-Tiger'
                                role = "img"
                                aria - label = 'tiger' > < /div> <
                                    div className = 'winner winner-Goat'
                                role = "img"
                                aria - label = 'goat' > < /div> <
                                    /div> <
                                    div className = {
