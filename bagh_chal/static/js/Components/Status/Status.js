...
const Status = ({
    ...
    return (
        ...
        onMouseEnter = {
            () => {
                setIsHoveringRules(true)
            }
        }
        onMouseLeave = {
            () => {
                setIsHoveringRules(false)
            }
        } >
        <
        Link to = '/Baghchal/rules' > {
            (isHoveringRules || showRules) ? < GiChecklist color = 'rgb(13, 179, 185)'
            size = {
                `3rem`
            }
            /> : <GiChecklist color = 'white' size={`3rem`}/ >
        } <
        /Link> <
        /div> <
        /div>
        ...
        <
        div className = {
            optionClass["vsPlayer2"]
        }
        onMouseEnter = {
            () => {
                handleHoverOptn('0', true)
            }
        }
        onMouseLeave = {
            () => {
                handleHoverOptn('0', false)
            }
        }
        onClick = {
            () => {
        ...
        onMouseEnter = {
            () => {
                handleHoverOptn('1', true)
            }
        }
        onMouseLeave = {
            () => {
                handleHoverOptn('1', false)
            }
        }
        onClick = {
            () => {
        ...
        /div> <
        IconContext.Provider value = {
            optionClass['innerIconsStyle']
        } >
        <
        div className = "click-btn" >
        <
        div className = {
            optionClass["vsTiger"][0]
        }
        onMouseEnter = {
            () => {
                handleHoverOptn('2', true)
            }
        }
        onMouseLeave = {
            () => {
                handleHoverOptn('2', false)
            }
        }
        onClick = {
            () => {
        ...
        /div> <
        span className = {
            optionClass["vsTiger"][1]
        } > VS Tiger < /span> <
        /div> { /* vs Goat */ } <
        div className = "click-btn " >
        <
        div className = {
            optionClass["vsGoat"][0]
        }
        onMouseEnter = {
            () => {
                handleHoverOptn('3', true)
            }
        }
        onMouseLeave = {
            () => {
                handleHoverOptn('3', false)
            }
        }
        onClick = {
            () => {
        ...
        span className = "display-numbers" > {
            statusArr[0]['trapStatus'].reduce((a, b) => (a + b))
        }
        / 4</span >
        <
        /div>    <
